  ...
  internal = rec {
    ...
    crates = {
      ...
      "megalodon" = rec {
        ...
        version = "0.13.3";
        edition = "2021";
        sha256 = "0n95apijw2h225h8i2y0zrfcz7a68b4glyjsyi9l3vic56c04wdi";
        authors = [
      ...
      "reqwest 0.12.3" = rec {
        ...
        version = "0.12.3";
        edition = "2021";
        sha256 = "06df5axmzam4bp6i3y3xf2jgakc71r963ppfbbmkd5b8kvlc2v1y";
        authors = [
          "Sean McArthur <sean@seanmonstar.com>"
        ];
        dependencies = [
        ...
        resolvedDefaultFeatures = [ "__rustls" "__tls" "json" "multipart" "rustls-pki-types" "rustls-tls" "rustls-tls-webpki-roots" "stream" ];
      };
      "ring" = rec {
        crateName = "ring";
        version = "0.17.8";
      ...
      "rustls 0.22.3" = rec {
        ...
        version = "0.22.3";
        edition = "2021";
        sha256 = "0g41l72ckvnjd3p8q5vmh5yvii9jwk0dpg97xhksbgmvs1x8s04r";
        dependencies = [
          {
            name = "log";
            packageId = "log";
      ...
      "rustls-pki-types" = rec {
        ...
        version = "1.4.1";
        edition = "2021";
        sha256 = "0izj2sa55iwziwsckxfqc66il5s3df616jjw6ca4agly4p26rlzc";
        features = {
          "default" = [ "alloc" ];
          "std" = [ "alloc" ];
          "web" = [ "web-time" ];
      ...
      "windows-sys 0.52.0" = rec {
        ...
        resolvedDefaultFeatures = [ "Win32" "Win32_Foundation" "Win32_Networking" "Win32_Networking_WinSock" "Win32_Security" "Win32_Security_Authentication" "Win32_Security_Authentication_Identity" "Win32_Security_Credentials" "Win32_Security_Cryptography" "Win32_System" "Win32_System_Console" "Win32_System_IO" "Win32_System_Memory" "Win32_System_Threading" "Win32_System_WindowsProgramming" "default" ];
      };
